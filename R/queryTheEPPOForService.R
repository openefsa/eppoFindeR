...
#' 
#' `queryTheEPPOForService` queries the EPPO database via REST API by specifying the name of 
...
#' 
#' @param service character. A single service, to be selected among the following:
#' 
#' \itemize{
...
#' EPPO code. The `queriedEppocode`, `queriedOn` and `queriedUrl` columns in the 
